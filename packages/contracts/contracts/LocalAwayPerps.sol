...
/// @title Simple Perpetuals for Local/Away index (positive domain)
/// @notice Educational prototype. Not audited. Do not use in production.
interface ILocalAwayOracleLike {
    function latestAnswer() external view returns (int256);
    function latestTimestamp() external view returns (uint256);
}

contract LocalAwayPerps {
    // Events
    ...
    ILocalAwayOracleLike public oracle;
    ...
    struct Position {
        ...
        uint256 lastUpdate;
        uint256 stopLoss;   // 1e8, 0 = unset
        uint256 takeProfit; // 1e8, 0 = unset
    }
    ...
    constructor(address _oracle) {
        oracle = ILocalAwayOracleLike(_oracle);
        owner = msg.sender;
    }
